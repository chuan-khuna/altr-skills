...
export const onRequest = defineMiddleware(async (context, next) => {
  const { serializeActionResult, deserializeActionResult } =
...
<ReadMore>Learn more about [`createSchema()`](/en/reference/content-loader-reference/#loadercreateschema) in the Content Loader API reference.</ReadMore>
